...
export class InitMigration1745404080673 implements MigrationInterface {
    name = 'InitMigration1745404080673'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "marca" ("id" SERIAL NOT NULL, "descricao" character varying NOT NULL, CONSTRAINT "PK_d41856ffd597050edc69ea5188d" PRIMARY KEY ("id"))`);
